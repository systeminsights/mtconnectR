...
[![Travis-CI Build Status](https://travis-ci.com/systeminsights/mtconnectR.svg?token=DSWsfhXECDvwFdEgzzgU&branch=master)](https://travis-ci.com/systeminsights/mtconnectR)
...
If you are still getting a 404 error, then you might need to have further authentication. Please contact the package maintainer in that case
...
* rawdata Original adapter log (parsed from which the data was created)
